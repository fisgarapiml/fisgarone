...
def gerar_css():
    ...
    fisgar_css = textwrap.dedent(r"""
        ...
        /* ... restante do CSS ... */
    """ )
    (css_dir / 'fisgar_ui_base.css').write_text(fisgar_css, encoding='utf-8')
    print(f"✅ CSS gerado: {css_dir / 'fisgar_ui_base.css'}")
...
def gerar_template_dashboard():
    ...
    html = textwrap.dedent("""
        ...
        <head>
            ...
            <link rel="stylesheet" href="/static/css/fisgar_ui_base.css">
